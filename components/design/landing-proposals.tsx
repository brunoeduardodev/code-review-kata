...
function DailyReviewSection() {
  return (
    <section className="mx-auto w-full max-w-[1240px] px-4 py-10 md:px-8" id="daily-review">
      <div className="reveal-up grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-end">
        <div>
          <p className="eyebrow">Daily Review</p>
          <h2 className="display-title mt-2 text-4xl md:text-5xl">
            Review today&apos;s PR without leaving the landing page
          </h2>
          <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--muted)] md:text-base">
            This is the product, not a teaser. Open the snippet, write findings, and debrief inline. Follow-up PRs
            still require sign-in before the queue unlocks.
          </p>
        </div>
        <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
          {proofMetrics.map((metric) => (
            <div key={metric.label} className="panel px-4 py-4">
              <p className="wire-label">Live Metric</p>
      ...
      <section className="mx-auto w-full max-w-[1240px] px-4 py-8 md:px-8" id="features">
        <div className="grid gap-4 lg:grid-cols-[1.35fr_0.65fr]">
          <article className="panel">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link className="btn-primary" href="#daily-review">
                Launch Ops Kata
              </Link>
              <a className="btn-secondary" href="#coverage">
